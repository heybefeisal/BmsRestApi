...
namespace BmsRestApi.Services.Implementations
{
    public class ProductService : IProductService
    {
        ...
        {
            var product = _messageMapper.MapToProduct(createProductRequest.Products);
        ...
        public UpdateProductResponse EditProduct(UpdateProductRequest updateProductRequest)
        {
            ...
            if (updateProductRequest.Id == updateProductRequest.Products.Id)
            {
                var product = _messageMapper.MapToProduct(updateProductRequest.Products);
        ...
        public FetchProductResponse GetProducts(FetchProductsRequest fetchProductsRequest)
        {
